module AnimatedInstancing.Raylib.Systems
...
module Crowd =
  ...
  let private buildTransforms(count: int) : Matrix4x4[] =
    ...
    Array.init count (fun i ->
      ...
      // raylib-native matrix layout: compose with Raymath ops, never
      // System.Numerics (their results are the transpose).
      Raymath.MatrixMultiply(
        Raymath.MatrixRotateY yaw,
        Raymath.MatrixTranslate(x, 0.0f, z)
      ))
