module Defli3D.State.Systems.Enemies
...
//   Defs      — static per enemy (models, reward); written once
//
// Projections:
...
//
// Positions are logical XZ-plane coordinates in world units (1 cell
// = 1 unit): x → x, y → z at the render edge.
// ─────────────────────────────────────────────────────────────
